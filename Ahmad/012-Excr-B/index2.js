...
class dog extends animal {
  ...
  showDogDetail() {
    console.log(
      `This dog have ${this.height} height and ${this.color} color and ${this.dogAge} years old`
    );
  }
}
...
class dogChild extends dog {
  ...
  showDogChildDetail() {
    console.log(
      `This dog have ${this.height} height and ${this.color} color and ${this.childAge} years old and have ${this.childEyes} eyes`
    );
  }
}
